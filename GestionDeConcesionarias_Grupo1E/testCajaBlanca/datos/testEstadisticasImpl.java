...
class testEstadisticasImpl {
	...
	@Nested
	@DisplayName("Prueba 11: Prueba del método platoMasSolicitado ")
	class P{
	...
	void testSolicitadoCP38() {
		...
		plato=new Plato("postre","helado de fresa");
		platos.put(plato,10);
		Plato plato2=new Plato("postre","Flan de cafÃ©");
		platos.put(plato2,7);
		
		//debe devolver el primer plato del array
		assertEquals(plato.getNombre(),est.platoMasSolicitado(platos).getNombre(),"El plato devuelto debe ser el de puntuaciÃ³n mÃ¡s alta.");
		assertEquals(plato.getTipo(),est.platoMasSolicitado(platos).getTipo(),"El plato devuelto debe ser del mismo tipo.");
	}
	}
	...
	class P2 {
		...
		void testEstadisticasCP30() {
			...
			assertEquals("Macarrones con queso", result.getPrimeroMasSolicitado().getNombre(),
					"El primero más solicitado debe ser macarrones.");
			assertEquals("Pollo asado", result.getSegundoMasSolicitado().getNombre(),
					"El segundo más solicitado debe ser pollo.");
			assertEquals("flan de huevo", result.getPostreMasSolicitado().getNombre(),
					"El postre más solicitado debe ser flan de huevo.");
		...
		void testEstadisticasCP32() {
			...
			Bandeja bandeja2 = new Bandeja(codigoBandeja, codigoVale, new Plato("primero", "Macarrones con queso"),
					new Plato("segundo", "Judías"), new Plato("postre", "flan de huevo"), new Bebida("agua"));
			valoraciones.add(bandeja2);

			result = est.generarEstadisticas(valoraciones);
			assertEquals("Macarrones con queso", result.getPrimeroMasSolicitado().getNombre(),
					"El primero más solicitado debe ser macarrones.");
			assertEquals("Judías", result.getSegundoMasSolicitado().getNombre(),
					"El segundo más solicitado debe ser pollo Y judías.");
			assertEquals("Pollo asado", result.getSegundoMasSolicitado().getNombre(),
					"El segundo más solicitado debe ser pollo Y judías.");
			assertEquals("flan de huevo", result.getPostreMasSolicitado().getNombre(),
					"El postre más solicitado debe ser flan de huevo.");
		...
		void testEstadisticasCP33() {
			...
			Bandeja bandeja2 = new Bandeja(codigoBandeja, codigoVale, new Plato("primero", "Macarrones con atún"),
					new Plato("segundo", "Pollo asado"), new Plato("postre", "flan de huevo"), new Bebida("agua"));
			valoraciones.add(bandeja2);

			result = est.generarEstadisticas(valoraciones);
			assertEquals("Macarrones con queso", result.getPrimeroMasSolicitado().getNombre(),
					"El primero más solicitado debe ser macarrones con atún y con queso.");
			assertEquals("Macarrones con atún", result.getPrimeroMasSolicitado().getNombre(),
					"El primero más solicitado debe ser macarrones con atún y con queso.");
			assertEquals("Pollo asado", result.getSegundoMasSolicitado().getNombre(),
					"El segundo más solicitado debe ser pollo.");
			assertEquals("flan de huevo", result.getPostreMasSolicitado().getNombre(),
		...
		void testEstadisticasCP34() {
			...
			Bandeja bandeja2 = new Bandeja(codigoBandeja, codigoVale, new Plato("primero", "Macarrones con queso"),
					new Plato("segundo", "Pollo asado"), new Plato("postre", "flan de café"), new Bebida("agua"));
			valoraciones.add(bandeja2);
			...
			assertEquals("Pollo asado", result.getSegundoMasSolicitado().getNombre(),
					"El segundo más solicitado debe ser pollo.");
			assertEquals("flan de huevo", result.getPostreMasSolicitado().getNombre(),
					"El postre más solicitado debe ser flan de huevo y de café.");
			assertEquals("flan de café", result.getPostreMasSolicitado().getNombre(),
					"El postre más solicitado debe ser flan de huevo y de café.");
