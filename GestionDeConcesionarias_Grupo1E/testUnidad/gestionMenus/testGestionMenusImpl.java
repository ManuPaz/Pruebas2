...
class testGestionMenusImpl {
	...
	void setUp() throws Exception {
		...
		primeros.add(plato);
		plato=new Plato("primero","At�n con queso");
		primeros.add(plato);
		plato=new Plato("primero","Sopa fr�a");
		primeros.add(plato);
		plato=new Plato("segundo","Pollo asado");
		segundos.add(plato);
		plato=new Plato("segundo","Jud�as");
		segundos.add(plato);
	...
	@DisplayName("CP03: Test construir menu, con platos que no son del tipo que deber�an ser")
	@Test
	...
	@DisplayName("CP04: Test construir menu, con una lista de bebidas vac�a y una lista con dos platos segundos")
	@Test
	...
	@DisplayName("CP05: Test construir menu, con un d�a que no existe y platos repetidos")
	@Test
